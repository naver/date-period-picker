angular.module('datePeriodPicker').run(['$templateCache', function($templateCache) {
  ...
  $templateCache.put('release/datepicker-modal.html',
    "<div id=\"custom-modal\" ng-click=\"close()\" ng-show=\"options.display\"><div id=\"overlay\" ng-click=\"$event.stopPropagation()\"><mg-datepicker mg-start=\"start\" mg-end=\"end\" mg-select=\"close()\" mg-button-name=\"buttonName\" mg-callback=\"callback\" mg-options=\"options\"></mg-datepicker></div><div id=\"fade\"></div></div>"
  );
